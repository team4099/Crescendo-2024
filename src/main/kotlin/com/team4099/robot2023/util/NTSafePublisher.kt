...
class NTSafePublisher : NT4Publisher() {
  override fun putTable(table: LogTable?) {
    // only stream data if we're not connected to FMS to reduce bandwidth issues
...
//  private val rootTable: NetworkTable =
...
//          LoggableType.FloatArray -> publisher!!.setFloatArray(newValue.floatArray,
// table.timestamp)
