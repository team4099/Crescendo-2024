...
object SuperstructureConstants {
  val distanceFlywheelSpeedTableSim =
    listOf(
      ...
      Pair(
        30.inches + FieldConstants.subwooferX + FieldConstants.edgeOfBumperToCenter,
        3000.rotations.perMinute
      ),
      Pair(
        60.inches + FieldConstants.subwooferX + FieldConstants.edgeOfBumperToCenter,
        3000.rotations.perMinute
      ),
      Pair(
        90.inches + FieldConstants.subwooferX + FieldConstants.edgeOfBumperToCenter,
        3500.rotations.perMinute
      ),
      Pair(
        120.inches + FieldConstants.subwooferX + FieldConstants.edgeOfBumperToCenter,
        4000.rotations.perMinute
      ),
      Pair(
        150.inches + FieldConstants.subwooferX + FieldConstants.edgeOfBumperToCenter,
        4000.rotations.perMinute
      )
    )
