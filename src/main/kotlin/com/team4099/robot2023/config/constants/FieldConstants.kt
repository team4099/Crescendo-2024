...
object FieldConstants {
  ...
  object Speaker {
    ...
    var topRightSpeaker = Translation3d(
      18.055.inches,
      238.815.inches,
      83.091.inches
    )

    var topLeftSpeaker = Translation3d(
      18.055.inches,
      197.765.inches,
      83.091.inches
    )

    var bottomRightSpeaker: Translation3d =
      Translation3d(0.0.inches, 238.815.inches, 78.324.inches)
    var bottomLeftSpeaker: Translation3d =
      Translation3d(0.0.inches, 197.765.inches, 78.324.inches)
