...
class ThreeNoteCenterlineFromAmpAutoPath(val drivetrain: Drivetrain, val superstructure: Superstructure) : SequentialCommandGroup() {
    init {
        ...
        addCommands(
            ...
            ParallelCommandGroup(
                ...
                WaitCommand(1.0).andThen(superstructure.prepManualSpeakerCommand(8.870702276919971.degrees).withTimeout(1.0))
            ),
                ...
                DrivePathCommand.createPathInFieldFrame(
                    drivetrain,
                    {
                        listOf(
                            ...
                            FieldWaypoint(
                                Translation2d((3.9 + 8.27).meters / 2, (6.45 + 7.45).meters / 2).translation2d,
                                null,
