    ...
    init {
        ...
        addCommands(
            ...
            ParallelCommandGroup(
                ...
                WaitCommand(0.5).andThen(superstructure.groundIntakeCommand()).andThen(WaitCommand(1.5))
                    .andThen( superstructure.prepManualSpeakerCommand(7.degrees, 4500.rotations.perSecond)),
            ),
            superstructure.scoreCommand().withTimeout(0.5),
            ParallelCommandGroup(
                DrivePathCommand.createPathInFieldFrame(
                ...
                WaitCommand(0.5).andThen(superstructure.groundIntakeCommand()).andThen(WaitCommand(0.5))
                    .andThen( superstructure.prepManualSpeakerCommand(7.degrees, 4500.rotations.perSecond)),
            ),
            superstructure.scoreCommand().withTimeout(0.5)
        )
