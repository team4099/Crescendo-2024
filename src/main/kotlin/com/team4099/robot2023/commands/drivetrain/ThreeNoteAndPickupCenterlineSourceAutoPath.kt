...
class ThreeNoteAndPickupCenterlineSourceAutoPath(val drivetrain: Drivetrain, val superstructure: Superstructure) : SequentialCommandGroup() {
    init {
                ...
                DrivePathCommand.createPathInFieldFrame(
                    drivetrain,
                    {
                        listOf(
                            ...
                            FieldWaypoint(
                                startingPose.translation.translation2d + Translation2d(2.inches, -2.inches).translation2d,
                                0.degrees.inRotation2ds,
                ...
                DrivePathCommand.createPathInFieldFrame(
                    drivetrain,
                    {
                        listOf(
                            ...
                            FieldWaypoint(
                                Translation2d((4.33.meters + 8.29.meters) / 2, (2.44 + 0.78).meters / 2 - 0.1.meters).translation2d,
                                null,
