...
class FollowPathCommand(val drivetrain: Drivetrain, val path: PathPlannerPath) : Command() {
    ...
    private val swerveDriveController: PathPlannerHolonomicDriveController

    private var trajCurTime = 0.0.seconds
    private var trajStartTime = 0.0.seconds

    private var currentDrivetrainRequest = Request.DrivetrainRequest.ClosedLoop(ChassisSpeeds(0.0, 0.0, 0.0))
...
//        val config = PathPlannerHolonomicDriveController()
...
//    }
    ...
    override fun execute() {
        ...
        drivetrain.currentRequest = currentDrivetrainRequest.also { it.chassisSpeeds = targetedChassisSpeeds.chassisSpeedsWPILIB}
