...
fun Pose3d.toDoubleArray(): Array<Double> {
    return arrayOf(this.x.inMeters, this.y.inMeters, this.z.inMeters, this.rotation.x.inRadians, this.rotation.y.inRadians, this.rotation.z.inRadians)
}
...
fun Transform3d.toDoubleArray(): Array<Double> {
    return arrayOf(this.translation.x.inMeters, this.translation.y.inMeters, this.translation.z.inMeters, this.rotation.x.inRadians, this.rotation.y.inRadians, this.rotation.z.inRadians)
}
...
fun Twist3d.toDoubleArray(): Array<Double> {
    return arrayOf(this.dx.inMeters, this.dy.inMeters, this.dz.inMeters, this.rx.inRadians, this.ry.inRadians, this.rz.inRadians)
}
